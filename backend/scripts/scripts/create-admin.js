...
function createAdmin() {
    return __awaiter(this, void 0, void 0, function () {
        var repo, email, password, name, existing, hashed, admin;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, AppDataSource.initialize()];
                case 1:
                    _a.sent();
                    repo = AppDataSource.getRepository(user_entity_1.User);
                ...
                case 3:
                    hashed = _a.sent();
                    admin = repo.create({ name: name, email: email, password: hashed, role: 'admin' });
