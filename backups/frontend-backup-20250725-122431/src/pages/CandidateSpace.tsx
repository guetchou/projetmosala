...
const CandidateSpace = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-[var(--color-mosala-green-500)] via-[var(--color-mosala-yellow-100)] to-[var(--color-mosala-dark-900)]" style={{ paddingTop: navbarHeight }}>
