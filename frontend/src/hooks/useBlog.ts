...
const officialMosalaPosts = [
  {
    ...
    date: "2024-10-10",
    image: "images-mosala/photos-projet-mosala/mosala-lancement-1536x1025.jpeg",
    category: "À la une",
  ...
  },
  {
    ...
    date: "2024-11-25",
    image: "images-mosala/photos-projet-mosala/photo-projet-mosala4.jpeg",
    category: "Formation",
    author: "FONEA",
  ...
  return useQuery({
    ...
    queryFn: async () => {
      try {
        ...
        return officialMosalaPosts.filter(post => post.featured);
      }
    }
  });
}
