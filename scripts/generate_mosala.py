...
folders = [
    "src/components/ui",
    "src/pages",
    "public/topcenter-uploads/carrousel",
    "public/topcenter-uploads/partenaires"
]
  ...
  return (
    <section className="relative min-h-screen overflow-hidden flex flex-col items-center justify-center text-center">
      ...
      <p className="text-lg md:text-xl mb-6 text-gray-700 dark:text-gray-200 max-w-2xl mx-auto animate-fade-in-up">
        Projet  inclusive pour l'emploi, l'accompagnement, la formation et la réussite professionnelle au Congo.
      </p>
...
const services = [
  ...
  },
  {
    ...
    icon: "/topcenter-uploads/community.png"
  }
];

const partnerLogos = [
  "/topcenter-uploads/partenaires/afd.jpeg",
  "/topcenter-uploads/partenaires/ministere.jpeg",
  "/topcenter-uploads/partenaires/ue.jpeg"
];
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-mosala-green-50 via-mosala-yellow-50 to-mosala-dark-50 relative">
      ...
      <section className="relative w-full flex flex-col items-center justify-center min-h-[340px] md:min-h-[420px] py-12 mb-8 overflow-hidden">
        <img
          src="/topcenter-uploads/carrousel/mosala1.jpeg"
          alt="Services Mosala"
...
const Formations = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-mosala-green-50 via-mosala-yellow-50 to-mosala-dark-50 relative">
      ...
      <section className="relative w-full flex flex-col items-center justify-center min-h-[340px] md:min-h-[420px] py-12 mb-8 overflow-hidden">
        <img
          src="/topcenter-uploads/carrousel/mosala2.jpeg"
