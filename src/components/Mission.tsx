...
import { Lightbulb, Rocket, HandHeart, Sparkles } from "lucide-react";
    ...
    <section className="py-16 bg-[var(--color-mosala-white)] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <motion.blockquote 
            className="text-xl md:text-2xl text-muted-foreground font-medium max-w-4xl mx-auto mb-8 relative"
            whileInView={{ scale: [0.9, 1.02, 1] }}
            viewport={{ once: true }}
            transition={{ duration: 1, delay: 0.3 }}
          >
            <motion.span
              className="absolute -left-4 -top-4 text-6xl text-primary/20"
            ...
            <motion.span
              className="absolute -right-4 -bottom-4 text-6xl text-primary/20"
              animate={{ rotate: [0, -10, 0] }}
                ...
                <motion.div
                  ...
                  whileHover={{
                    boxShadow: [
                      ...
                      "0 0 0 10px rgba(255, 213, 0, 0)",
                      "0 0 0 20px rgba(255, 213, 0, 0)"
                    ]
                  }}
                  transition={{ duration: 0.6 }}
                />
