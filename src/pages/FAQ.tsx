    ...
    questions: [
      {
        ...
        answer: "Mosala est la première plateforme d'emploi et d'accompagnement au Congo. Nous connectons les talents congolais aux opportunités d'emploi et de formation pour favoriser l'insertion professionnelle des jeunes."
      },
      {
      ...
      },
      {
        ...
        answer: "Oui, Mosala est accessible dans tout le Congo. Notre plateforme est optimisée pour les connexions faibles et fonctionne même en mode hors-ligne pour certaines fonctionnalités."
      }
    ]
  },
  {
      ...
      <main className="flex-1 container mx-auto px-4 py-12 max-w-4xl">
        ...
        >
          ...
          <p className="text-lg text-[var(--color-mosala-dark-600)] max-w-2xl mx-auto">
            Trouvez rapidement les réponses à vos questions sur Mosala, nos services, et l'utilisation de la plateforme.
          </p>
        </motion.div>
